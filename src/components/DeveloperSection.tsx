...
const developers = [
  {
    ...
    bio: "Passionate about creating impactful technology for social good. Led the development of Izyl's core architecture, real-time alert system, and location tracking features.",
  ...
  },
  {
    ...
    bio: "Designer and developer focused on creating intuitive, accessible interfaces. Designed Izyl's visual identity, user experience flows, and responsive layouts.",
  ...
  },
  {
    ...
    bio: "Backend specialist ensuring Izyl runs fast and secure. Built the notification system, database architecture, and encryption layers for maximum user privacy.",
